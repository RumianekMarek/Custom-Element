...
echo '<div style=" text-align: justify; max-width: 600px; margin: 0 auto; font-family: "Open Sans", "Montserrat", sans-serif; "> 
    ...
    <div style="padding: 0 5px">
        <h3 style="font-size: 18px; margin: 20px 0 10px; text-align: left;">
            <span class="name__email">Dear Madam/Sir</span>
        </h3>
        <p style="font-size: 14px; margin: 25px 0 10px;">
           I hope this message finds you in good health.
            I would like to inform you that we will soon contact you by phone to discuss a proposal regarding your participation in the trade fair organized in Poland, in Warsaw, by Ptak Warsaw Expo.
            During a brief conversation, we will provide you with essential information on this topic. If you have any questions or prefer a specific time for the call, please reply to this message. We want to ensure that the conversation takes place at a convenient time for you.
            Thank you in advance for your cooperation, and we look forward to speaking with you.
        </p>
        <p style="font-size: 14px; margin: 25px 0 10px; text-align: center;">
            <b>You can find the details of the event on our website.</b>
        </p>
