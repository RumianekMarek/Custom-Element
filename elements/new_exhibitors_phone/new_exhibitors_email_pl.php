    ...
    <div style="padding: 0 5px">
        ...
        <table>
            <tbody>
                <tr>
                    <td style="width: 45%">
                        <div style="margin: 12px auto; border-radius:20px; inline-size: fit-content; text-align: center;">
                    ...
                    <td style="width: 45%">
                        <div style="margin: 12px auto; border-radius:20px; inline-size: fit-content;">
