<div id="orgInfo"class="custom-container-org-info">
    ...
    <div class="pl_PL custom-org-info-fixed-width single-block-padding">
        ...
        <div id="procedury-stoisk" class="custom-org-info-content-item">
            ...
            <p>Osoba odbierająca powierzchnię jeśli nie jest to Wystawca (np. wykonawca zabudowy) powinien posiadać podpisane przez Wystawcę oryginał upoważnienia podpisanego i opieczętowanego przez Wystawcę. Osoby upoważnione przez Wystawcę do wykonania zabudowy w celu swobodnego poruszania się po terenie Targów powinny posiadać identyfikatory techniczne, które będą dostępne w Punkcie Technicznej Obsługi Wystawców.</p>
            <p>Identyfikatory techniczne należy uzupełnić danymi osób upoważnionych do montażu stoiska.</p>
        ...
        <div id="rozladunek" class="custom-org-info-content-item">
        ...
        <div id="dokumenty" class="custom-org-info-content-item">
