<div id="faq" class="custom-container-faq style-accent-bg color-white">
  <div class="heading-text el-text secondary-heading-text half-block-padding pl_PL">
    <h4 class="color-white">Poznaj odpowiedzi na najczęściej zadawane pytania</h4>
  </div>
  <div class="heading-text el-text secondary-heading-text half-block-padding en_US">
    <h4 class="color-white">Get answers to the most frequently asked questions</h4>
  </div>
