        ...
        if(isset($menu_1_en) && isset($menu_2_en) && isset($menu_3_en)){ echo '
            <div class="custom-footer-nav">
                <div class="custom-footer-nav-wrapper">
                    ...
                    <div class="custom-footer-nav-left-column">
                        <div class="custom-footer-nav-logo-column">
                            <div class="custom-footer-nav-logo-top"><a href="' . $base_url . '/en"><img src="/wp-content/plugins/custom-element/media/logo_pwe_ufi.webp"></a></div>
                            <div class="custom-footer-nav-logo-bottom text-centered">
                                <a href="' . $base_url . '/en">
                                    ';
    ...
    if (get_locale() == "en_US") {
        echo '<script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    const footerMenu = document.querySelector(".custom-footer-nav-right-column");
                    const footerThirdChild = footerMenu.children[2];
                    const footerMenuChild = footerThirdChild.querySelector(".custom-footer-nav-column .menu");
