<div class="custom-container-grupy style-accent-bg shadow-black single-block-padding">
  ...
  <div style="color:white !important;">
    <p>
      ...
      ';} else { echo '
        To ensure your comfortable participation in our events, admission for organized groups is only possible on the last day of the fair. Before your arrival, we encourage you to contact us through the form available on the website:  <a style="color:white !important;" href="https://warsawexpo.eu/en/groups">warsawexpo.eu/en/groups</a>.
