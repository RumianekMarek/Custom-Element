            ...
            <div class="custom-route-transport-block custom-half-width drive">
                ...
                <div class="custom-route-transport-item custom-flex">
                    ...
                    <div class="custom-route-transport-item-text">
                        <?php if($locale == 'pl_PL'){ echo '
                            <h5>SAMOLOTEM</h5>
                            <p>Do Ptak Warsaw Expo z Międzynarodowego Portu Lotniczego im. Fryderyka Chopina dotrzeć można w niespełna 10 minut! Nasze Centrum jest również dogodnie położone względem lotniska w Modlinie oraz Łodzi.</p>
                        ';} else { echo '
                            <h5>BY PLANE</h5>
                ...
                <div class="custom-route-transport-item custom-flex">
                    ...
                    <div class="custom-route-transport-item-text">
                        <?php if($locale == 'pl_PL'){ echo '   
                            <h5>POCIĄGIEM</h5>
                            <p>Warszawa posiada trzy stacje kolejowe dla pociągów dalekobieżnych: Dworzec Centralny (Warszawa Centralna), Dworzec Wschodni (Warszawa Wschodnia) oraz Dworzec Zachodni (Warszawa Zachodnia). Z dworca zachodniego do Ptak Warsaw Expo można dojechać samochodem już w 13 minut (wg Google).</p>
                        ';} else { echo '    
                            <h5>BY TRAIN</h5>
                ...
                <div class="custom-route-transport-item custom-flex">
                    ...
                    <div class="custom-route-transport-item-text">
                        <?php if($locale == 'pl_PL'){ echo '
                            ...
                            <p>Autobusy linii 703, 711 z zajezdni Krakowska P+R do przystanku „Paszków” lub autobus 733 do przystanku „Centrum Mody”. Uwaga! „Przystanek Paszków” i „Centrum mody” mieszczą się w II strefie biletowej. W bilety zaopatrzyć się można w większości kiosków, w biletomatach oraz autobusach.</p>
                        ';} else { echo ' 
                            <h5>BY CITY BUS</h5>
                ...
                <div class="custom-route-transport-item custom-flex">
                    ...
                    <div class="custom-route-transport-item-text">
                        <?php if($locale == 'pl_PL'){ echo '
                            <h5>SAMOCHODEM</h5>
                            <p>Ptak Warsaw Expo znajduje się bezpośrednio przy trasie S8 w kierunku na Katowice. Zjazd Paszków. Dojazd z okolic lotniska Okęcie zajmie około 10 minut. Z centrum Warszawy – 15 minut. Z parkowaniem nie będzie problemu, nasze centrum dysponuje 15 000 miejsc parkingowych!</p>
                        ';} else { echo ' 
                            <h5>BY CAR</h5>
