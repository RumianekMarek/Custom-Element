<div id="organizator" class="custom-container-organizator">
  <div class="custom-organizator-text">
    <p class="border-top-left"  style="box-shadow: -3px -3px white;">&nbsp;</p>
    ...
    <p  class="en_US" style="color:white !important;">
    ...
    <p class="border-bottom-right"  style="box-shadow: 3px 3px white;">&nbsp;</p>
  </div>
</div>