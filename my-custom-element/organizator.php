<div id="organizator" class="custom-container-organizator">
  <div class="custom-organizator-text">
    <p class="border-top-left ">&nbsp;</p>
    <h5 class="custom-organizator-header pl_PL" style="color:white;">O organizatorze</h5>
    <h5 class="custom-organizator-header en_US" style="color:white;">About the organizer</h5>

    <p  class="pl_PL color-white">
