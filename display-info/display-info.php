    ...
    vc_map(array(
      ...
      'params' => array(
        ...
        array(
            'type' => 'checkbox',
            'group' => 'options',
            'heading' => __('Photo as aquare', 'my-custom-plugin'),
...
function info_box_output($atts, $content = null) {
    ...
    $display_speakers = str_replace(';', '<br>', $event_speaker);

    $html .= '<h4 class="lectur-time">' . $event_time . '</p>
            <h5 class="lecturer-name" style="color:'.$lect_color.';">'.$display_speakers.'</p> 
